...
# თუ ცხრილების წაშლა დაგვჭირდა
drop table students;
drop table courses;
drop table student_courses;

select * from courses c inner join student_courses sc on c.id = sc.course_id;
select * from courses c left join student_courses sc on c.id = sc.course_id;
